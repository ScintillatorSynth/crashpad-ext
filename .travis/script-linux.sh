...
echo "extra_ldflags=\"$TRAVIS_BUILD_DIR/boringssl/build/ssl/libssl.a $TRAVIS_BUILD_DIR/boringssl/build/crypto/libcrypto.a /usr/local/ssl/lib/libssl.a\"" >> out/Default/args.gn
echo "args.gn:"
